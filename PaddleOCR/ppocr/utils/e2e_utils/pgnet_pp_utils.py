...
class PGNet_PostProcess(object):
    ...
    def __init__(self, character_dict_path, valid_set, score_thresh, outs_dict, shape_list):
    ...
    def pg_postprocess_fast(self):
        ...
        instance_yxs_list, seq_strs = generate_pivot_list_fast(
            p_score, p_char, p_direction, self.Lexicon_Table, score_thresh=self.score_thresh
        )
