...
from paddle.nn.initializer import Constant as constant_, XavierNormal as xavier_normal_, XavierNormal as xavier_uniform_
...
class Transformer(nn.Layer):
    ...
    def __init__(
        ...
        self.embedding = Embeddings(
            d_model=d_model, vocab=dst_vocab_size, padding_idx=0, scale_embedding=scale_embedding
        )
        ...
        if custom_encoder is not None:
            ...
            if num_encoder_layers > 0:
                encoder_layer = TransformerEncoderLayer(
                    d_model, nhead, dim_feedforward, attention_dropout_rate, residual_dropout_rate
                )
    ...
    def forward_beam(self, images):
        ...
        with paddle.no_grad():
            ...
            src_enc = src_enc.reshape([n_inst * n_bm, len_s, d_h]).transpose([1, 0, 2])
            # -- Prepare beams
