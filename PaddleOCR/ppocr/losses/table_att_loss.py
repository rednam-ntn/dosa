...
class TableAttentionLoss(nn.Layer):
    ...
    def giou_loss(self, preds, bbox, eps=1e-7, reduction="mean"):
        ...
        iw = fluid.layers.clip(ix2 - ix1 + 1e-3, 0.0, 1e10)
        ih = fluid.layers.clip(iy2 - iy1 + 1e-3, 0.0, 1e10)
        ...
        ew = fluid.layers.clip(ex2 - ex1 + 1e-3, 0.0, 1e10)
        eh = fluid.layers.clip(ey2 - ey1 + 1e-3, 0.0, 1e10)
