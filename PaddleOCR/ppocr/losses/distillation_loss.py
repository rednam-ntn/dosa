...
class DistillationDMLLoss(DMLLoss):
    ...
    def __init__(self, model_name_pairs=[], act=None, use_log=False, key=None, maps_name=None, name="dml"):
        ...
        for idx, pair in enumerate(self.model_name_pairs):
            ...
            if self.maps_name is None:
                ...
                for _c, k in enumerate(outs1.keys()):
                    ...
                    if isinstance(loss, dict):
                        for key in loss:
                            loss_dict["{}_{}_{}_{}_{}".format(key, pair[0], pair[1], map_name, idx)] = loss[key]
                    else:
